...
procs(4)
core1 = remotecall(run,1, r, v, m, 1e-3, 6.325, 1000)
core2 = remotecall(run,2, r, v, m, 1e-3, 6.325, 1000)
core3 = remotecall(run,3, r, v, m, 1e-3, 6.325, 1000)
core4 = remotecall(run,4, r, v, m, 1e-3, 6.325, 1000)
a,b,c = fetch(core1)
print(a,b,c)
